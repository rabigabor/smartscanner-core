...
//    val preference = context?.getSharedPreferences(resources.getString(R.string.app_name), Context.MODE_PRIVATE)
...
//            Toast.makeText(activity, ""+sharedPref.getString("name","lll")+"", Toast.LENGTH_LONG).show()
